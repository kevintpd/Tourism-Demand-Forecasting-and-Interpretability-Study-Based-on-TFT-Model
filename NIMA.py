...
def predict(model, data_generator):
    # return model.predict(load_and_preprocess_image("./test_images/aesthetic3.jpg"))
...
def main(base_model_name, weights_file, image_source, predictions_file, img_format='jpg'):
    ...
    print(calc_mean_score(predictions))
    print("111"*10)
    ...
    with open('output-dzdp.json', 'w') as f:
...
if __name__ == '__main__':
    ...
    #
    # args = parser.parse_args("InceptionV3",'imagenet',"./test.jpg")
    #
    # main(**args.__dict__)
    main("MobileNet",'./weights_mobilenet_aesthetic_0.07.hdf5',"./大众点评图片-所有/",None)